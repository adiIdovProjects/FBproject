            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-8">
                            {features.items.map((feature, index) => (
                                ...
                                >
                                    <div className="flex size-10 items-center justify-center rounded-lg bg-[#0d9488]/10 text-[#0d9488]">
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="aspect-square bg-gradient-to-br from-[#0d9488]/20 to-transparent rounded-3xl p-8 border border-slate-200 dark:border-slate-800 flex items-center justify-center">
                            <div className="w-full h-full bg-[#192233] rounded-2xl shadow-2xl overflow-hidden border border-slate-700 relative group">
                                <div className="p-6 border-b border-slate-700 flex justify-between items-center">
                                    ...
                                    <div className="h-6 w-16 bg-[#0d9488] rounded"></div>
                                </div>
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#0d9488]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            </div>
                        </div>
                    </motion.div>
                </div>
