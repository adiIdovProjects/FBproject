...
/**
 * Homepage3 - Task-oriented homepage
...
import ActionCard from '../../../components/homepage3/ActionCard';
...
export default function Homepage3() {
  ...
  const { data: campaigns } = useQuery({
    queryKey: ['homepage3-campaigns', startDate, endDate, selectedAccountId],
    queryFn: () =>
