...
const PricingPage = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white dark:bg-[#0B0F1A]">
            <LandingNavbar />
            <main className="flex-1 pt-8 pb-16">
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div
                        ...
                        className="bg-slate-50 dark:bg-slate-900/50 rounded-3xl border border-slate-200 dark:border-white/10 p-8 md:p-12 shadow-xl"
                    >
                        <div className="mb-10">
                            ...
                            <div className="relative mb-6">
                                <input
                                    ...
                                    style={{
                                        background: `linear-gradient(to right, #6366F1 0%, #6366F1 ${(currentStopIndex / (sliderStops.length - 1)) * 100}%, #e2e8f0 ${(currentStopIndex / (sliderStops.length - 1)) * 100}%, #e2e8f0 100%)`
                                    }}
                                />
                                <div className="flex justify-between mt-2 text-xs text-slate-500">
                                    {sliderStops.map((stop, i) => (
                                        <span key={i} className={i === currentStopIndex ? 'text-indigo-500 font-semibold' : ''}>
                                            {formatSpend(stop)}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div className="text-center">
                                <div className="inline-flex items-center gap-2 bg-indigo-500/10 text-indigo-500 px-4 py-2 rounded-full text-sm font-semibold">
                        ...
                        <div className="text-center mb-10 pb-10 border-b border-slate-200 dark:border-white/10">
                        ...
                        <div className="text-center">
                            {currentTier.price === 'Contact' ? (
                                ...
                                <Link
                                    href={`/${locale}/login`}
                                    className="inline-flex items-center gap-2 h-14 px-10 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 text-white font-bold text-lg transition-all hover:translate-y-[-2px] hover:shadow-lg hover:shadow-indigo-500/30 active:scale-95"
                                >
                    ...
                    >
                        <div className="inline-flex items-start gap-3 bg-slate-100 dark:bg-slate-900/50 p-4 rounded-xl text-left max-w-xl">
