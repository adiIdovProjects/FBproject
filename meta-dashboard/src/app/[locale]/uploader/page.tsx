...
export default function CampaignChoicePage() {
    ...
    // Load campaigns when duplicate is selected OR when add creative is selected
    useEffect(() => {
    ...
    // Load adsets when campaign is selected in "Add Creative" path
    useEffect(() => {
            ...
            <div className="max-w-4xl mx-auto" dir={isRTL ? 'rtl' : 'ltr'}>
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">
                        {t('uploader.what_would_you_like') || 'What would you like to do?'}
                    </h1>
                    <p className="text-gray-400">
                        {t('uploader.choose_path_desc') || 'Choose the option that best fits your goal'}
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    {/* Add Creative Sub-Options: Campaign and Ad Set Selection */}
                    {selectedPath === 'add' && (
                        <div className="ml-6 p-5 bg-purple-500/5 rounded-xl border-2 border-purple-500/30 space-y-4">
